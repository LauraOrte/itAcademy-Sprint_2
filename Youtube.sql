...
CREATE TABLE IF NOT EXISTS lista_playlists (
	lista_playlists INT NOT NULL,
	lista_videos INT NOT NULL,
	FOREIGN KEY (lista_playlists) REFERENCES playlists (id),
    FOREIGN KEY (lista_videos) REFERENCES videos (id)
);
