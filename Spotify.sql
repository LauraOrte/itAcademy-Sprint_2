...
CREATE TABLE IF NOT EXISTS playlists_activa (
	id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS playlists_eliminada (
	id INT NOT NULL AUTO_INCREMENT,
	títol VARCHAR(60) NOT NULL,
	número_cançons INT NOT NULL,
	data_creació DATE,
...
CREATE TABLE IF NOT EXISTS cançons_compartides (
	playlists_activa INT NOT NULL,
    cançons INT NOT NULL,
    usuari INT NOT NULL,
    FOREIGN KEY (playlists_activa) REFERENCES playlists_activa (id),
	FOREIGN KEY (cançons) REFERENCES cançó (id),
	FOREIGN KEY (usuari) REFERENCES usuari (id)
 );   
 
 CREATE TABLE IF NOT EXISTS artista_seguidors_llista (
 ...
 CREATE TABLE IF NOT EXISTS favorit_albums (
	albums_favorit  INT NOT NULL,
    usuari INT NOT NULL,
    FOREIGN KEY (albums_favorit) REFERENCES àlbum (id),
	FOREIGN KEY (usuari) REFERENCES usuari (id)
 );
 
 CREATE TABLE IF NOT EXISTS favorit_cançons (
	cançons_favorit INT NOT NULL,
    usuari INT NOT NULL,
    FOREIGN KEY (cançons_favorit) REFERENCES cançó (id),
    FOREIGN KEY (usuari) REFERENCES usuari (id)
 );   
